...
@Since("0.8.0")
@DeveloperApi
abstract class GeneralizedLinearModel @Since("1.0.0") (                      //GeneralizedLinearModel类
...
@Since("0.8.0")
@DeveloperApi
abstract class GeneralizedLinearAlgorithm[M <: GeneralizedLinearModel]               //GeneralizedLinearAlgorithm类
  ...
  def run(input: RDD[LabeledPoint], initialWeights: Vector): M = {
    ...
    if (validateData && !validators.forall(func => func(input))) {    //数据合法性验证
